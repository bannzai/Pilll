...
class CalendarScheduledMenstruationBand extends StatelessWidget {
  const CalendarScheduledMenstruationBand({super.key, required this.begin, required this.end, required this.width});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CustomPaint(
        painter: DiagonalStripedLine(color: AppColors.menstruation.withOpacity(0.6), isNecessaryBorder: true),
