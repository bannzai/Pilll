...
extension DateTimeAdd on DateTime {
  DateTime addDays(int offset) {
    return DateTime(year, month, day + offset, hour, minute, second, millisecond, microsecond);
  }
}

extension TZDateTimeAdd on TZDateTime {
  TZDateTime addDays(int offset) {
    return TZDateTime(location, year, month, day + offset, hour, minute, second, millisecond, microsecond);
  }
}
