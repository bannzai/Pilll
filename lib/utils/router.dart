...
// So, Don't forget when this function is edited. Both test necessary .
  static Future<void> endInitialSetting(NavigatorState navigator,
      BoolSharedPreferences didEndInitialSettingNotifier) async {
  ...
  static Future<void> routeToInitialSetting(NavigatorState navigator,
      BoolSharedPreferences didEndInitialSettingNotifier) async {
