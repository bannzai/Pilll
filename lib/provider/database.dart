...
class DatabaseConnection {
  ...
  DocumentReference<User> userReference() => FirebaseFirestore.instance.collection(_CollectionPath.users).doc(userID).withConverter(
  ...
  DocumentReference<DiarySetting> diarySettingReference() => FirebaseFirestore.instance.collection(_CollectionPath.settings(userID)).doc("diary").withConverter(
  ...
  DocumentReference<Diary> diaryReference(Diary diary) => FirebaseFirestore.instance.collection(_CollectionPath.diaries(userID)).doc(diary.id).withConverter(
        fromFirestore: _diaryFromFirestore,
        toFirestore: _diaryToFirestore,
      );
  ...
  final FromFirestore<Menstruation> _menstruationFromFirestore = (snapshot, options) => Menstruation.fromJson(snapshot.data()!..putIfAbsent("id", () => snapshot.id));
  final ToFirestore<Menstruation> _menstruationToFirestore = (menstruation, options) => menstruation.toJson();
  CollectionReference<Menstruation> menstruationsReference() => FirebaseFirestore.instance.collection(_CollectionPath.menstruations(userID)).withConverter(
        fromFirestore: _menstruationFromFirestore,
        toFirestore: _menstruationToFirestore,
      );
  DocumentReference<Menstruation> menstruationReference(String? menstruationID) => FirebaseFirestore.instance.collection(_CollectionPath.menstruations(userID)).doc(menstruationID).withConverter(
        fromFirestore: _menstruationFromFirestore,
        toFirestore: _menstruationToFirestore,
      );
  ...
  CollectionReference<PillSheetModifiedHistory> pillSheetModifiedHistoriesReference() => FirebaseFirestore.instance.collection(_CollectionPath.pillSheetModifiedHistories(userID)).withConverter(
  ...
  final FromFirestore<PillSheetGroup> _pillSheetGroupFromFirestore = (snapshot, options) => PillSheetGroup.fromJson(snapshot.data()!..putIfAbsent("id", () => snapshot.id));
  final ToFirestore<PillSheetGroup> _pillSheetGroupToFirestore = (pillSheetGroup, options) => pillSheetGroup.toJson();
  CollectionReference<PillSheetGroup> pillSheetGroupsReference() => FirebaseFirestore.instance.collection(_CollectionPath.pillSheetGroups(userID)).withConverter(
  ...
  final FromFirestore<Schedule> _scheduleFromFirestore = (snapshot, options) => Schedule.fromJson(snapshot.data()!..putIfAbsent("id", () => snapshot.id));
  final ToFirestore<Schedule> _scheduleToFirestore = (schedule, options) => schedule.toJson();
  CollectionReference<Schedule> schedulesReference() => FirebaseFirestore.instance.collection(_CollectionPath.schedules(userID: userID)).withConverter(
        fromFirestore: _scheduleFromFirestore,
        toFirestore: _scheduleToFirestore,
      );
  DocumentReference<Schedule> scheduleReference(String scheduleID) => FirebaseFirestore.instance.doc(_CollectionPath.schedule(userID: userID, scheduleID: scheduleID)).withConverter(
        fromFirestore: _scheduleFromFirestore,
        toFirestore: _scheduleToFirestore,
      );
