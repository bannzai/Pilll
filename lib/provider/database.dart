...
abstract class _CollectionPath {
  ...
  static String schedule(
          {required String userID, required String scheduleID}) =>
...
class DatabaseConnection {
  ...
  final ToFirestore<Schedule> _scheduleToFirestore =
      (schedule, options) => schedule.toJson();
  ...
  DocumentReference<PilllAds?> pilllAds() =>
      FirebaseFirestore.instance.doc(_CollectionPath.pilllAds()).withConverter(
