...
final diariesForMonthProvider =
    StreamProvider.family((ref, DateTime dateForMonth) {
...
final setDiaryProvider =
    Provider((ref) => SetDiary(ref.watch(databaseProvider)));
...
final deleteDiaryProvider =
    Provider((ref) => DeleteDiary(ref.watch(databaseProvider)));
