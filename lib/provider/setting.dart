...
final settingProvider = StreamProvider<Setting>((ref) => ref
...
final setSettingProvider =
    Provider((ref) => SetSetting(ref.watch(databaseProvider)));
...
final batchSetSettingProvider =
    Provider((ref) => BatchSetSetting(ref.watch(databaseProvider)));
