...
part of 'premium_and_trial.codegen.dart';
...
mixin _$PremiumAndTrial {
  ...
  @JsonKey(ignore: true)
  $PremiumAndTrialCopyWith<PremiumAndTrial> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$_PremiumAndTrial extends _PremiumAndTrial {
  ...
  @override
  String toString() {
    return 'PremiumAndTrial(isTrial: $isTrial, isPremium: $isPremium, hasDiscountEntitlement: $hasDiscountEntitlement, beginTrialDate: $beginTrialDate, trialDeadlineDate: $trialDeadlineDate, discountEntitlementDeadlineDate: $discountEntitlementDeadlineDate)';
  }
