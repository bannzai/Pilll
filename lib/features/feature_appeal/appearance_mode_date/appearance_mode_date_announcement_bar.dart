...
/// ピルシート外観モード(date) (有料機能) を AnnouncementBar 領域でアピールする Bar。
class AppearanceModeDateAnnouncementBar extends StatelessWidget {
  /// 親 (FeatureAppealBarsContainer) が所有する dismissed フラグ。× ボタン押下で true にする。
  final ValueNotifier<bool> isClosed;
  const AppearanceModeDateAnnouncementBar({super.key, required this.isClosed});
    ...
    return Container(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Navigator.of(context).push(AppearanceModeDateHelpPageRoute.route());
        },
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    L.appearanceModeDateFeatureAppealTitle,
                  ...
                  Text(
                    L.appearanceModeDateFeatureAppealShortDescription,
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 10,
                      fontFamily: FontFamily.japanese,
