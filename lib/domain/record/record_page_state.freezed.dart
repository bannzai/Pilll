...
class _$RecordPageStateTearOff {
  ...
  _RecordPageState call(
      ...
      bool recommendPremiumPlainInTrialIsAlreadyClose = false,
...
class _$_RecordPageState extends _RecordPageState {
  const _$_RecordPageState(
      ...
      this.recommendPremiumPlainInTrialIsAlreadyClose = false,
