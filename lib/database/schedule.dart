...
final schedulesForDateProvider = FutureProvider.family((ref, DateTime date) async {
...
final schedulesForMonthProvider = FutureProvider.family((ref, DateTime dateForMonth) async {
