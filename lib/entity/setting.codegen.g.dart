...
_ReminderTime _$ReminderTimeFromJson(Map<String, dynamic> json) =>
    _ReminderTime(hour: (json['hour'] as num).toInt(), minute: (json['minute'] as num).toInt());

Map<String, dynamic> _$ReminderTimeToJson(_ReminderTime instance) => <String, dynamic>{'hour': instance.hour, 'minute': instance.minute};
