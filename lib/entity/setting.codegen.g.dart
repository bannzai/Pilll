...
_$ReminderTimeImpl _$$ReminderTimeImplFromJson(Map<String, dynamic> json) =>
    _$ReminderTimeImpl(hour: (json['hour'] as num).toInt(), minute: (json['minute'] as num).toInt());

Map<String, dynamic> _$$ReminderTimeImplToJson(_$ReminderTimeImpl instance) => <String, dynamic>{'hour': instance.hour, 'minute': instance.minute};
