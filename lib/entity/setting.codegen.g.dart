...
_$SettingImpl _$$SettingImplFromJson(Map<String, dynamic> json) =>
    _$SettingImpl(
      pillSheetTypes:
          (json['pillSheetTypes'] as List<dynamic>?)
      ...
      reminderNotificationCustomization:
          ...
          : ReminderNotificationCustomization.fromJson(
              json['reminderNotificationCustomization'] as Map<String, dynamic>,
            ),
      useCriticalAlert: json['useCriticalAlert'] as bool? ?? false,
      criticalAlertVolume:
          (json['criticalAlertVolume'] as num?)?.toDouble() ?? 0.5,
...
Map<String, dynamic> _$$SettingImplToJson(_$SettingImpl instance) =>
    <String, dynamic>{
      ...
      'reminderNotificationCustomization': instance
          .reminderNotificationCustomization
          .toJson(),
