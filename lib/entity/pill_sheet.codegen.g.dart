...
_$PillSheetTypeInfoImpl _$$PillSheetTypeInfoImplFromJson(Map<String, dynamic> json) => _$PillSheetTypeInfoImpl(
...
Map<String, dynamic> _$$PillSheetTypeInfoImplToJson(_$PillSheetTypeInfoImpl instance) => <String, dynamic>{
...
_$RestDurationImpl _$$RestDurationImplFromJson(Map<String, dynamic> json) => _$RestDurationImpl(
...
Map<String, dynamic> _$$RestDurationImplToJson(_$RestDurationImpl instance) => <String, dynamic>{
      'id': instance.id,
...
_$PillSheetV1Impl _$$PillSheetV1ImplFromJson(Map<String, dynamic> json) => _$PillSheetV1Impl(
      ...
      beginDate: NonNullTimestampConverter.timestampToDateTime(json['beginingDate'] as Timestamp),
...
Map<String, dynamic> _$$PillSheetV1ImplToJson(_$PillSheetV1Impl instance) {
  ...
  val['beginingDate'] = NonNullTimestampConverter.dateTimeToTimestamp(instance.beginDate);
...
_$PillSheetV2Impl _$$PillSheetV2ImplFromJson(Map<String, dynamic> json) => _$PillSheetV2Impl(
      ...
      restDurations: (json['restDurations'] as List<dynamic>).map((e) => RestDuration.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$$PillSheetV2ImplToJson(_$PillSheetV2Impl instance) {
  ...
  writeNotNull('id', instance.id);
  val['typeInfo'] = instance.typeInfo.toJson();
  val['beginDate'] = NonNullTimestampConverter.dateTimeToTimestamp(instance.beginDate);
  val['createdAt'] = TimestampConverter.dateTimeToTimestamp(instance.createdAt);
  val['deletedAt'] = TimestampConverter.dateTimeToTimestamp(instance.deletedAt);
  val['groupIndex'] = instance.groupIndex;
  val['restDurations'] = instance.restDurations.map((e) => e.toJson()).toList();
