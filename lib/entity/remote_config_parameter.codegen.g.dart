...
_$RemoteConfigParameterImpl _$$RemoteConfigParameterImplFromJson(Map<String, dynamic> json) => _$RemoteConfigParameterImpl(
  ...
  premiumIntroductionShowsAppStoreReviewCard:
      json['premiumIntroductionShowsAppStoreReviewCard'] as bool? ?? RemoteConfigParameterDefaultValues.premiumIntroductionShowsAppStoreReviewCard,
  specialOfferingUserCreationDateTimeOffset:
      (json['specialOfferingUserCreationDateTimeOffset'] as num?)?.toInt() ??
  ...
  specialOfferingUserCreationDateTimeOffsetSince:
      (json['specialOfferingUserCreationDateTimeOffsetSince'] as num?)?.toInt() ??
  ...
  specialOfferingUserCreationDateTimeOffsetUntil:
      (json['specialOfferingUserCreationDateTimeOffsetUntil'] as num?)?.toInt() ??
