...
Map<String, dynamic> _$$PillSheetModifiedHistoryImplToJson(
  ...
  final val = <String, dynamic>{'version': instance.version};
  ...
  val['ttlExpiresDateTime'] = TimestampConverter.dateTimeToTimestamp(
    instance.ttlExpiresDateTime,
  );
  val['archivedDateTime'] = TimestampConverter.dateTimeToTimestamp(
    instance.archivedDateTime,
  );
