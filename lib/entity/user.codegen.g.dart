...
_$UserImpl _$$UserImplFromJson(Map<String, dynamic> json) => _$UserImpl(
  ...
  userDocumentIDSets:
      (json['userDocumentIDSets'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  anonymousUserIDSets:
      (json['anonymousUserIDSets'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
...
Map<String, dynamic> _$$UserImplToJson(_$UserImpl instance) =>
    <String, dynamic>{
      ...
      'beginTrialDate': TimestampConverter.dateTimeToTimestamp(
        instance.beginTrialDate,
      ),
      'trialDeadlineDate': TimestampConverter.dateTimeToTimestamp(
        instance.trialDeadlineDate,
      ),
