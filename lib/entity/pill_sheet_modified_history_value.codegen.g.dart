...
Map<String, dynamic> _$$TakenPillEditedValueImplToJson(_$TakenPillEditedValueImpl instance) => <String, dynamic>{
...
Map<String, dynamic> _$$EndedPillSheetValueImplToJson(_$EndedPillSheetValueImpl instance) => <String, dynamic>{
...
_$BeganRestDurationValueImpl _$$BeganRestDurationValueImplFromJson(Map<String, dynamic> json) =>
    _$BeganRestDurationValueImpl(restDuration: RestDuration.fromJson(json['restDuration'] as Map<String, dynamic>));

Map<String, dynamic> _$$BeganRestDurationValueImplToJson(_$BeganRestDurationValueImpl instance) => <String, dynamic>{
  'restDuration': instance.restDuration.toJson(),
};

_$EndedRestDurationValueImpl _$$EndedRestDurationValueImplFromJson(Map<String, dynamic> json) =>
    _$EndedRestDurationValueImpl(restDuration: RestDuration.fromJson(json['restDuration'] as Map<String, dynamic>));

Map<String, dynamic> _$$EndedRestDurationValueImplToJson(_$EndedRestDurationValueImpl instance) => <String, dynamic>{
  'restDuration': instance.restDuration.toJson(),
};
...
Map<String, dynamic> _$$ChangedRestDurationBeginDateValueImplToJson(_$ChangedRestDurationBeginDateValueImpl instance) => <String, dynamic>{
  'beforeRestDuration': instance.beforeRestDuration.toJson(),
  'afterRestDuration': instance.afterRestDuration.toJson(),
};

_$ChangedRestDurationValueImpl _$$ChangedRestDurationValueImplFromJson(Map<String, dynamic> json) => _$ChangedRestDurationValueImpl(
  beforeRestDuration: RestDuration.fromJson(json['beforeRestDuration'] as Map<String, dynamic>),
  afterRestDuration: RestDuration.fromJson(json['afterRestDuration'] as Map<String, dynamic>),
);

Map<String, dynamic> _$$ChangedRestDurationValueImplToJson(_$ChangedRestDurationValueImpl instance) => <String, dynamic>{
  'beforeRestDuration': instance.beforeRestDuration.toJson(),
  'afterRestDuration': instance.afterRestDuration.toJson(),
};
