...
_$PillTakenImpl _$$PillTakenImplFromJson(Map<String, dynamic> json) =>
    _$PillTakenImpl(
...
Map<String, dynamic> _$$PillTakenImplToJson(_$PillTakenImpl instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$$PillImplToJson(_$PillImpl instance) =>
    <String, dynamic>{
