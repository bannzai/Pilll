...
export 'package:pilll/entity/pill_sheet.codegen.dart';
...
extension PillSheetGroupRestDurationDomain on PillSheetGroup {
  ...
  PillSheet get targetBeginRestDurationPillSheet {
    ...
    if (lastTakenPillSheetOrFirstPillSheet.isEnded) {
  ...
  DateTime get availableRestDurationBeginDate {
    ...
    if (lastTakenDate == null) {
      ...
      // if (pillSheetGroup.lastTakenPillSheetOrFirstPillSheet.isEnded)
      // true: 0番以外のピルシート
      // false: 0番のピルシート
