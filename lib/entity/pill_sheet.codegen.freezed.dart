...
// NOTE: [SyncData:Widget] このプロパティはWidgetに同期されてる
  ...
  TResult when<TResult extends Object?>({
    ...
    return v1(id, typeInfo, beginDate, lastTakenDate, createdAt, deletedAt,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return v1?.call(id, typeInfo, beginDate, lastTakenDate, createdAt,
...
// required int pillTakenCount,
  ...
  TResult when<TResult extends Object?>({
    ...
    return v2(id, typeInfo, beginDate, createdAt, deletedAt, groupIndex,
        restDurations, pills, version);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return v2?.call(id, typeInfo, beginDate, createdAt, deletedAt, groupIndex,
        restDurations, pills, version);
  }
