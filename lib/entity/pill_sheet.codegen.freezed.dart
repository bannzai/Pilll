...
// NOTE: [SyncData:Widget] このプロパティはWidgetに同期されてる
  ...
  @override
  String toString() {
    return 'PillSheet.v1(id: $id, typeInfo: $typeInfo, beginingDate: $beginingDate, lastTakenDate: $lastTakenDate, createdAt: $createdAt, deletedAt: $deletedAt, groupIndex: $groupIndex, restDurations: $restDurations, pillTakenCount: $pillTakenCount)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, typeInfo, beginingDate, lastTakenDate, createdAt, deletedAt, groupIndex,
      const DeepCollectionEquality().hash(_restDurations), pillTakenCount);
  ...
  TResult when<TResult extends Object?>({
    ...
    return v1(id, typeInfo, beginingDate, lastTakenDate, createdAt, deletedAt, groupIndex, restDurations, pillTakenCount);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return v1?.call(id, typeInfo, beginingDate, lastTakenDate, createdAt, deletedAt, groupIndex, restDurations, pillTakenCount);
  }
...
abstract class PillSheetV1 extends PillSheet {
  const factory PillSheetV1(
      ...
      final int pillTakenCount}) = _$PillSheetV1Impl;
...
// NOTE: [SyncData:Widget] このプロパティはWidgetに同期されてる
  ...
  @override
  String toString() {
    return 'PillSheet.v2(id: $id, typeInfo: $typeInfo, beginingDate: $beginingDate, lastTakenDate: $lastTakenDate, createdAt: $createdAt, deletedAt: $deletedAt, groupIndex: $groupIndex, restDurations: $restDurations, pillTakenCount: $pillTakenCount, pills: $pills)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, typeInfo, beginingDate, lastTakenDate, createdAt, deletedAt, groupIndex,
      const DeepCollectionEquality().hash(_restDurations), pillTakenCount, const DeepCollectionEquality().hash(_pills));
  ...
  TResult when<TResult extends Object?>({
    ...
    return v2(id, typeInfo, beginingDate, lastTakenDate, createdAt, deletedAt, groupIndex, restDurations, pillTakenCount, pills);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return v2?.call(id, typeInfo, beginingDate, lastTakenDate, createdAt, deletedAt, groupIndex, restDurations, pillTakenCount, pills);
  }
...
abstract class PillSheetV2 extends PillSheet {
  const factory PillSheetV2(
      ...
      final List<RestDuration> restDurations,
      final int pillTakenCount,
      required final List<Pill> pills}) = _$PillSheetV2Impl;
