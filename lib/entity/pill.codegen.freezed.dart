...
abstract class _$$PillTakenImplCopyWith<$Res>
  ...
  factory _$$PillTakenImplCopyWith(
    _$PillTakenImpl value,
    $Res Function(_$PillTakenImpl) then,
...
class __$$PillTakenImplCopyWithImpl<$Res>
  ...
  __$$PillTakenImplCopyWithImpl(
    _$PillTakenImpl _value,
    $Res Function(_$PillTakenImpl) _then,
  ) : super(_value, _then);
...
class _$PillImpl extends _Pill {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.takenCount, takenCount) ||
  ...
  int get hashCode => Object.hash(
    ...
    createdDateTime,
    updatedDateTime,
    const DeepCollectionEquality().hash(_pillTakens),
  );
