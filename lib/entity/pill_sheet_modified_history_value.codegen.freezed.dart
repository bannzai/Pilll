...
// 実際の服用時刻。ユーザーが編集した後の服用時刻
  ...
  DateTime get actualTakenDate =>
      throw _privateConstructorUsedError; // 元々の履歴がDBに書き込まれた時刻。通常はユーザーが編集する前の服用時刻
  @JsonKey(
      fromJson: NonNullTimestampConverter.timestampToDateTime,
      toJson: NonNullTimestampConverter.dateTimeToTimestamp)
...
// 終了した日付。サーバーで書き込まれる
  ...
  DateTime get endRecordDate =>
      throw _privateConstructorUsedError; // 終了した時点での最終服用日
  @JsonKey(
      fromJson: NonNullTimestampConverter.timestampToDateTime,
      toJson: NonNullTimestampConverter.dateTimeToTimestamp)
...
// 番号を変更した事が無い場合もあるのでnullable
        ...
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.beforeDisplayNumberSetting,
                ...
                other.beforeDisplayNumberSetting ==
                    beforeDisplayNumberSetting) &&
            (identical(other.afterDisplayNumberSetting,
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, beforeDisplayNumberSetting, afterDisplayNumberSetting);
