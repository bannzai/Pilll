...
void main() {
  ...
  group("#cardState", () {
    ...
    test(
      "if latestMenstruation is exists but out of duration and latest pill sheet is null",
      () async {
        final originalTodayRepository = todayRepository;
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
    ...
    test(
      "if latestMenstruation is exists but out of duration and setting is null",
      () async {
        final originalTodayRepository = todayRepository;
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
