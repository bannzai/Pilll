...
void main() {
  ...
  group('notification bar appearance content type', () {
    group('for it is not premium user', () {
      testWidgets('#RecommendPremiumPlainInTrialNotificationBar',
...
// NOTE: Into rest duration and notification duration
        ...
        final state = NotificationBarState(
          ...
          beginTrialDate: today.subtract(Duration(days: 15)),
        ...
        expect(
          find.byWidgetPredicate((widget) =>
              widget is RecommendPremiumPlainInTrialNotificationBar),
          findsOneWidget,
        );
      });
