  ...
  group("#RecordPagePillSheet.textOfPillNumber", () {
    group("pillSheetAppearanceMode is number", () {
      ...
      test("it is isPremium or isTrial", () {
        ...
        final pillSheet = PillSheet(id: const Uuid().v4(), typeInfo: PillSheetType.pillsheet_21.typeInfo, beginingDate: today);
  ...
  group("#RecordPagePillSheet.displayPillTakeDate", () {
    test("it is not have rest duration", () {
      ...
      final PillSheet pillSheet =
          PillSheet(id: const Uuid().v4(), typeInfo: PillSheetType.pillsheet_21_0.typeInfo, beginingDate: DateTime.parse("2020-09-01"));
