...
void main() {
  ...
  group("#todayPillNumber", () {
    ...
    group("休薬期間がある場合", () {
      ...
      test("境界値テスト：休薬期間終了日の翌日の場合", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2020-09-26"));
    ...
    group("時刻を含むDateTimeの場合", () {
      test("同じ日の異なる時刻でも日付レベルで比較される", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2020-09-06T23:59:59"));

        const sheetType = PillSheetType.pillsheet_21;
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          // 朝の時刻で開始
          beginDate: DateTime.parse("2020-09-01T08:00:00"),
      ...
      test("開始日と同日で時刻が開始時刻より前でも1番を返す", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2020-09-01T06:00:00"));
    ...
    group("年をまたぐ場合", () {
      test("12/31開始で1/1が2番目", () {
        ...
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          beginDate: DateTime.parse("2020-12-31"),
      ...
      test("12/15開始で1/15が32番目", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2021-01-15"));
    ...
    group("うるう年の場合", () {
      test("2/28開始で2/29が2番目（うるう年）", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2020-02-29"));

        const sheetType = PillSheetType.pillsheet_21;
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          beginDate: DateTime.parse("2020-02-28"),
      ...
      test("2/28開始で3/1が3番目（うるう年）", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2020-03-01"));
  ...
  group("#pillNumberFor", () {
    group("基本的なケース（休薬期間なし）", () {
      test("targetDateが開始日と同日の場合は1番を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-01")),
          1,
        );
      });
      ...
      test("targetDateが開始日の翌日の場合は2番を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-02")),
          2,
        );
      });
      ...
      test("targetDateが開始日から6日目の場合は6番を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-06")),
          6,
        );
      });
      ...
      test("targetDateが開始日より前の場合はmax関数により1を返す（下限保護）", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-08-31")),
          1,
        );
      });
      ...
      test("targetDateが開始日の2日前の場合でも1を返す（下限保護）", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-08-30")),
          1,
        );
      });
      ...
      test("境界値テスト：21日目の場合は21番を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-21")),
          21,
        );
      });
      ...
      test("境界値テスト：28日目の場合は28番を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-28")),
          28,
        );
      });
      ...
      test("ピルシート範囲外の日付（29日目以降）でも計算結果を返す（上限制限なし）", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-29")),
          29,
        );
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-30")),
          30,
        );
      });
    });
    ...
    group("時刻を含む境界値テスト", () {
      test("targetDateの00:00:00とtargetDateの23:59:59は同じピル番号を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime(2020, 9, 10, 0, 0, 0)),
          10,
        );
        expect(
          model.pillNumberFor(targetDate: DateTime(2020, 9, 10, 23, 59, 59)),
          10,
        );
      });
      ...
      test("開始日に時刻が含まれていてもtargetDateの日付で正しく計算される", () {
        ...
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          beginDate: DateTime(2020, 9, 1, 10, 30, 0),
          lastTakenDate: null,
          createdAt: DateTime.parse("2020-09-01"),
          typeInfo: PillSheetTypeInfo(
            dosingPeriod: sheetType.dosingPeriod,
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime(2020, 9, 1, 0, 0, 0)),
          1,
        );
        expect(
          model.pillNumberFor(targetDate: DateTime(2020, 9, 2, 8, 0, 0)),
          2,
        );
      });
    });
    ...
    group("休薬期間がある場合", () {
      test("休薬期間が終了していない場合、targetDateが休薬開始後だと休薬日数分が差し引かれる", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-15")),
          11,
        );
      });
      ...
      test("境界値テスト：targetDateが休薬期間開始日より前の場合は休薬期間の影響を受けない", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-10")),
          10,
        );
      });
      ...
      test("境界値テスト：targetDateが休薬期間開始日と同日の場合、休薬期間の影響は0日", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-11")),
          11,
        );
      });
      ...
      test("境界値テスト：targetDateが休薬期間開始日の翌日の場合は1日分差し引かれる", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-12")),
          11,
        );
      });
      ...
      test("境界値テスト：targetDateが休薬期間終了日と同日の場合", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-14")),
          11,
        );
      });
    ...
    group("複数の休薬期間がある場合", () {
      test("複数の休薬期間がすべて終了している場合、合計日数が差し引かれる", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-20")),
          16,
        );
      });
      ...
      test("境界値テスト：targetDateが最初の休薬期間より前の場合、休薬期間の影響を受けない", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-05")),
          5,
        );
      });
    });
    ...
    group("異なるPillSheetTypeの場合", () {
      ...
      test("pillsheet_24_0（24錠すべて実薬）の場合", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-24")),
          24,
        );
      });
    ...
    group("エッジケース", () {
      ...
      test("3つの休薬期間がすべて終了している場合、合計日数が差し引かれる", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-09-25")),
          21,
        );
      });
      ...
      test("targetDateがかなり開始日より前（30日前）の場合でも1を返す（下限保護）", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-08-01")),
          1,
        );
      });
      ...
      test("targetDateがピルシート期間を大幅に超えた場合でも計算結果を返す", () {
        ...
        expect(
          model.pillNumberFor(targetDate: DateTime.parse("2020-10-01")),
          31,
        );
      });
    });
  ...
  group("#isActive", () {
    group("開始日の境界値テスト", () {
      ...
      test("開始日当日の23:59:59はアクティブ", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime(2020, 9, 1, 23, 59, 59));
      ...
      test("開始日前日の23:59:59は非アクティブ", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime(2020, 8, 31, 23, 59, 59));
  ...
  group("#isActiveFor", () {
    // isActiveFor(date) は beginDate から estimatedEndTakenDate の範囲内に date が含まれるかを判定
    ...
    group("beginDateに時刻が含まれている場合", () {
      test("beginDateが12:30:00でも日付部分のみで判定される", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          // beginDateに時刻を含める
          beginDate: DateTime(2020, 9, 1, 12, 30, 0),
          lastTakenDate: null,
          createdAt: now(),
          typeInfo: PillSheetTypeInfo(
            dosingPeriod: sheetType.dosingPeriod,
  ...
  group("#isBegan", () {
    ...
    test("開始日と同日の場合はfalseを返す（境界値: beginDate.date() < now() で等しい場合はfalse）", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      // DateTime.parse は 00:00:00 を返すため、beginDate.date() と now() が同じ値になる
    ...
    test("開始日当日で時刻部分がある場合はtrueを返す（beginDate.date()は00:00:00に正規化されるため）", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      // now()に時刻部分があると、beginDate.date() = 00:00:00 < now() = 12:00:00 となりtrue
      when(
        mockTodayRepository.now(),
      ).thenReturn(DateTime(2020, 9, 1, 12, 0, 0));
  ...
  group("#inNotTakenDuration", () {
    ...
    group("休薬期間（RestDuration）がある場合", () {
      ...
      test(
        "RestDuration により todayPillNumber が dosingPeriod 以下に留まっている場合は false を返す",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
      ...
      test(
        "RestDuration が終了し、todayPillNumber が dosingPeriod を超えた場合は true を返す",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
      ...
      test(
        "境界値テスト：RestDuration により todayPillNumber が dosingPeriod と同じになる場合は false を返す",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
      ...
      test(
        "境界値テスト：RestDuration により todayPillNumber が dosingPeriod + 1 になる場合は true を返す",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
  ...
  group("#lastTakenOrZeroPillNumber", () {
    ...
    test(
      "beginDate > lastTakenDateの場合は0になる。服用日が開始日より前になる。「今日飲むピル番号」の調整機能で1つ目のピルを選択した時",
      () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
    ...
    test("境界値テスト：休薬期間終了日と同日が最終服用日の場合", () {
      ...
      // beginDate: 2020-09-01, lastTakenDate: 2020-09-22
    ...
    group("v2", () {
      test("未服用の場合は0を返す", () {
        ...
        expect(pillSheet.lastTakenOrZeroPillNumber, 0);
      });

      test("1錠だけ飲んでいる場合（takenCount=2、1錠服用）でもpillTakensがあるので該当番号を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        expect(pillSheet.lastTakenOrZeroPillNumber, 1);
      });

      test("3日目まで完全に服用している場合は3を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-04"));
        ...
        expect(pillSheet.lastTakenOrZeroPillNumber, 3);
      });

      test("5日目まで完全に服用している場合は5を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-06"));
        ...
        final pillSheet = PillSheet.v2(
          ...
          pills: Pill.testGenerateAndIterateTo(
            pillSheetType: sheetType,
            fromDate: DateTime.parse("2022-05-01"),
            lastTakenDate: DateTime.parse("2022-05-05"),
            pillTakenCount: 2,
          ),
          typeInfo: PillSheetTypeInfo(
            dosingPeriod: sheetType.dosingPeriod,
        ...
        expect(pillSheet.lastTakenOrZeroPillNumber, 5);
      });

      test("休薬期間がある場合でも正しいピル番号を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-15"));
        ...
        final pillSheet = PillSheet.v2(
          ...
          restDurations: [
            RestDuration(
              id: "rest_duration_id",
              beginDate: DateTime.parse("2022-05-06"),
              endDate: DateTime.parse("2022-05-08"),
              createdDate: DateTime.parse("2022-05-06"),
            ),
          ],
          pills: Pill.testGenerateAndIterateTo(
            pillSheetType: sheetType,
            fromDate: DateTime.parse("2022-05-01"),
            lastTakenDate: DateTime.parse("2022-05-10"),
            pillTakenCount: 2,
          ),
          typeInfo: PillSheetTypeInfo(
            dosingPeriod: sheetType.dosingPeriod,
  ...
  group("#lastTakenPillNumber", () {
    ...
    test(
      "beginDate > lastTakenDateの場合はnullになる。服用日が開始日より前になる。「今日飲むピル番号」の調整機能で1つ目のピルを選択した時",
      () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
    ...
    group("時刻境界値テスト", () {
      test("同日だがlastTakenDateの時刻がbeginDateより前の場合はnullを返す", () {
        // lastTakenPillNumber は lastTakenDate.isBefore(beginDate) で時刻も含めて比較している
        // 同日でも時刻が前であればnullを返す
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
        ...
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          beginDate: DateTime(2020, 9, 14, 12, 0, 0),
      ...
      test("同日でlastTakenDateの時刻がbeginDateより後の場合は1を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
          beginDate: DateTime(2020, 9, 14, 10, 0, 0),
    ...
    group("v2", () {
      test("未服用の場合はnullを返す", () {
        ...
        expect(pillSheet.lastTakenPillNumber, null);
      });

      test("1日目を完全服用している場合は1を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        expect(pillSheet.lastTakenPillNumber, 1);
      });
      ...
      test("3日目まで完全に服用している場合は3を返す", () {
        ...
        expect(pillSheet.lastTakenPillNumber, 3);
      });
    });
  });
  group("#todayPillIsAlreadyTaken", () {
    ...
    test("境界値テスト：lastTakenDateが今日の0:00:00の場合はtrueを返す", () {
      ...
      when(
        mockTodayRepository.now(),
      ).thenReturn(DateTime(2020, 9, 19, 12, 0, 0));
    ...
    test("境界値テスト：lastTakenDateが今日の23:59:59の場合はtrueを返す", () {
      ...
      when(
        mockTodayRepository.now(),
      ).thenReturn(DateTime(2020, 9, 19, 8, 0, 0));
    ...
    test("境界値テスト：lastTakenDateが昨日の23:59:59の場合はfalseを返す", () {
      ...
      when(
        mockTodayRepository.now(),
      ).thenReturn(DateTime(2020, 9, 19, 0, 0, 0));
    ...
    test("境界値テスト：lastTakenDateが明日の0:00:00の場合はtrueを返す", () {
      ...
      when(
        mockTodayRepository.now(),
      ).thenReturn(DateTime(2020, 9, 19, 23, 59, 59));
  ...
  group("#isTakenAll", () {
    ...
    group("lastTakenDate が beginDate より前の場合", () {
      test("28錠タイプ - isTakenAll は false を返す", () {
        const sheetType = PillSheetType.pillsheet_28_0;
        final model = PillSheet.v1(
          id: firestoreIDGenerator(),
    ...
    group("v2", () {
      test("全ピル完了の場合はtrueを返す", () {
        ...
        expect(pillSheet.isTakenAll, true);
      });

      test("途中までしか服用していない場合はfalseを返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        expect(pillSheet.isTakenAll, false);
      });

      test("最終日（28日目）が未服用の場合はfalseを返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
      ...
      test("最終日（28日目）を2回中1回だけ服用した場合はfalseを返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        // 28日目は部分服用（2回中1回）であり服用完了ではないので false
        expect(pillSheet.isTakenAll, false);
      });
    });
  });
  group("#lastCompletedOrZeroPillNumber", () {
    test("v1では服用=完了なのでlastTakenOrZeroPillNumberと同じ値を返す", () {
      const sheetType = PillSheetType.pillsheet_28_0;
      final model = PillSheet.v1(
        id: firestoreIDGenerator(),
        beginDate: DateTime.parse("2020-09-01"),
      ...
      expect(model.lastCompletedOrZeroPillNumber, 10);
      expect(model.lastCompletedOrZeroPillNumber, model.lastTakenOrZeroPillNumber);
    });

    group("v2", () {
      test("2番目のピルを2回中1回だけ服用した場合、完了済みの1を返す（lastTakenOrZeroPillNumberは2を返す）", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        pills[1] = pills[1].copyWith(
          pillTakens: [
            PillTaken(
              recordedTakenDateTime: DateTime.parse("2022-05-02"),
              createdDateTime: now(),
              updatedDateTime: now(),
            ),
          ],
        ...
        expect(pillSheet.lastCompletedOrZeroPillNumber, 1);
        expect(pillSheet.lastTakenOrZeroPillNumber, 2);
      });
      ...
      test("未服用の場合は0を返す", () {
        ...
        expect(pillSheet.lastCompletedOrZeroPillNumber, 0);
      });
    });
  });
  group("#estimatedEndTakenDate", () {
    ...
    group("異なるPillSheetTypeでのテスト", () {
      test(
        "pillsheet_24_0の場合、totalCount=24なので開始日から24日目がestimatedEndTakenDate",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
          ...
          expect(
            pillSheet.estimatedEndTakenDate,
            DateTime.parse("2022-05-25").subtract(const Duration(seconds: 1)),
          );
        },
      );

      test(
        "pillsheet_21_0の場合、totalCount=21なので開始日から21日目がestimatedEndTakenDate",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
          ...
          expect(
            pillSheet.estimatedEndTakenDate,
            DateTime.parse("2022-05-22").subtract(const Duration(seconds: 1)),
          );
        },
      );

      test(
        "pillsheet_28_4の場合、totalCount=28なので開始日から28日目がestimatedEndTakenDate",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
      ...
      test(
        "pillsheet_24_rest_4の場合、totalCount=28なので開始日から28日目がestimatedEndTakenDate",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
      ...
      test(
        "pillsheet_28_7の場合、totalCount=28なので開始日から28日目がestimatedEndTakenDate",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
      ...
      test(
        "pillsheet_28_0の場合、totalCount=28なので開始日から28日目がestimatedEndTakenDate",
        () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
    ...
    group("now()の日付による休薬期間計算の違い", () {
      test("now()が休薬期間開始前の場合、休薬期間は計算に含まれない", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-05"));
      ...
      test("now()が休薬期間中の場合、開始日からnow()までの日数が休薬期間として計算される", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-13"));
      ...
      test("now()が休薬期間終了後の場合、終了した休薬期間全体が計算に含まれる", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-20"));
  ...
  group("#activeRestDuration", () {
    ...
    test(
      "最後のRestDurationのendDateがnullでbeginDateがnow()より前の場合はそのRestDurationを返す",
      () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
    ...
    test(
      "境界値テスト：最後のRestDurationのbeginDateがnow()と同日の場合はRestDurationを返す（!isAfterは同日を含む）",
      () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
    ...
    group("境界値テスト：服用お休み開始日が今日の場合", () {
      test("beginDateの時刻がnow()より後でもRestDurationを返す。beginDateは日付レベルで比較される", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime(2022, 5, 10, 8, 0, 0));
      ...
      test("beginDateの時刻がnow()より前の場合もRestDurationを返す", () {
        ...
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime(2022, 5, 10, 23, 0, 0));
  ...
  group("#dates", () {
    ...
    test("PillSheetType.pillsheet_28_4の場合は28日分の日付が返る", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-10"));
      ...
      expect(actual.length, 28);
      expect(actual.first, DateTime.parse("2022-05-01"));
      expect(actual.last, DateTime.parse("2022-05-28"));
    });
    test("PillSheetType.pillsheet_28_0の場合は28日分の日付が返る", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-10"));
    ...
    test("PillSheetType.pillsheet_24_rest_4の場合は28日分の日付が返る", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-10"));
    ...
    group("全PillSheetTypeに対するdates.lengthの検証", () {
      for (final sheetType in PillSheetType.values) {
        test("$sheetType の場合、dates.lengthがtotalCountと一致する", () {
          final mockTodayRepository = MockTodayService();
          todayRepository = mockTodayRepository;
          when(
            mockTodayRepository.now(),
          ...
          expect(pillSheet.dates.length, sheetType.totalCount);
        });
      }
    });
  });
  group("#displayPillTakeDate", () {
    group("休薬期間なし", () {
      ...
      test("ピル番号14の場合、開始日から13日後を返す", () {
        ...
        expect(pillSheet.displayPillTakeDate(14), DateTime.parse("2022-05-14"));
      });

      test("ピル番号28（最後）の場合、開始日から27日後を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
      ...
      test("21錠タイプの場合、ピル番号21が最後の日付を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-21"));
      ...
      test("28錠タイプ（24錠実薬＋4錠偽薬）の場合、ピル番号28が最後の日付を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
    ...
    group("休薬期間あり（終了済み）", () {
      test("休薬期間前のピル番号は休薬期間の影響を受けない", () {
        ...
        // ピル番号1〜9は休薬期間前なので影響を受けない
        expect(pillSheet.displayPillTakeDate(1), DateTime.parse("2022-05-01"));
        expect(pillSheet.displayPillTakeDate(9), DateTime.parse("2022-05-09"));
      });

      test("休薬期間後のピル番号は休薬日数分ずれる（2日間の休薬）", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        // ピル番号10は本来05-10だが、休薬2日間で05-12にずれる
        expect(pillSheet.displayPillTakeDate(10), DateTime.parse("2022-05-12"));
        // ピル番号11は本来05-11だが、休薬2日間で05-13にずれる
        expect(pillSheet.displayPillTakeDate(11), DateTime.parse("2022-05-13"));
        // ピル番号28は本来05-28だが、休薬2日間で05-30にずれる
        expect(pillSheet.displayPillTakeDate(28), DateTime.parse("2022-05-30"));
      });
    });

    group("休薬期間あり（継続中）", () {
      test("継続中の休薬期間の場合、todayまでの日数分ずれる", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        // 休薬開始05-10、today=05-15なので5日間の休薬
        // ピル番号10は本来05-10だが、05-15にずれる
        expect(pillSheet.displayPillTakeDate(10), DateTime.parse("2022-05-15"));
        // ピル番号11は本来05-11だが、05-16にずれる
        expect(pillSheet.displayPillTakeDate(11), DateTime.parse("2022-05-16"));
      });
    });

    group("複数の休薬期間", () {
      test("複数の終了済み休薬期間がある場合、累積でずれる", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-05-25"));
        ...
        final pillSheet = PillSheet.v1(
          ...
          restDurations: [
            RestDuration(
              id: firestoreIDGenerator(),
              beginDate: DateTime.parse("2022-05-08"),
              endDate: DateTime.parse("2022-05-10"), // 2日間
              createdDate: now(),
            ),
            RestDuration(
              id: firestoreIDGenerator(),
        ...
        // ピル番号8は本来05-08だが、最初の休薬2日間で05-10にずれる
        expect(pillSheet.displayPillTakeDate(8), DateTime.parse("2022-05-10"));
        // ピル番号12は本来05-12だが、最初の休薬2日間で05-14、さらに2回目の休薬3日間で05-17
        // ただしここでは2回目の休薬開始日は05-15で、ピル番号12の日付(05-14)より後なので
        // 2回目の休薬は影響しない。ピル番号12は05-14
        expect(pillSheet.displayPillTakeDate(12), DateTime.parse("2022-05-14"));
        // ピル番号14は本来05-14だが、最初の休薬で05-16、さらに2回目の休薬で05-19
        // 2回目の休薬開始日05-15 <= 05-16なので影響を受ける
        expect(pillSheet.displayPillTakeDate(14), DateTime.parse("2022-05-19"));
      });
    });
  });
  group("#buildDates", () {
    test("estimatedEventCausingDateが指定された場合、その日付を上限として計算する", () {
      ...
      final actualWithEstimatedDate = pillSheet.buildDates(
        estimatedEventCausingDate: DateTime.parse("2022-05-15"),
      );
    ...
    test("24日型ピルシート（pillsheet_24_0）の場合、24個の日付が返される", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-30"));
      ...
      // pillsheet_24_0はtotalCount=24なので24個の日付が返される
      expect(actual.length, 24);
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[11], DateTime.parse("2022-05-12"));
      expect(actual[23], DateTime.parse("2022-05-24"));
    });
    test("21日型ピルシート（pillsheet_21_0）の場合、21個の日付が返される", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-30"));
      ...
      // pillsheet_21_0はtotalCount=21なので21個の日付が返される
      expect(actual.length, 21);
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[10], DateTime.parse("2022-05-11"));
      expect(actual[20], DateTime.parse("2022-05-21"));
    });
    test("24錠+4日休薬（pillsheet_24_rest_4）の場合、28個の日付が返される", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-06-01"));
      ...
      // pillsheet_24_rest_4はtotalCount=28なので28個の日付が返される
      expect(actual.length, 28);
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[23], DateTime.parse("2022-05-24"));
      expect(actual[27], DateTime.parse("2022-05-28"));
    });
    test("休薬期間がピルシート終了日付近にある場合（境界値テスト）", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      ...
      final pillSheet = PillSheet.v1(
        ...
        restDurations: [
          RestDuration(
            id: firestoreIDGenerator(),
            beginDate: DateTime.parse("2022-05-25"), // ピルシート終盤
            endDate: DateTime.parse("2022-05-28"), // 3日間
            createdDate: now(),
          ),
        ],
        typeInfo: PillSheetTypeInfo(
      ...
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[23], DateTime.parse("2022-05-24"));
      // 25日目は休薬期間（3日間）の影響で05-28になる
      expect(actual[24], DateTime.parse("2022-05-28"));
      // 28日目は3日ずれて05-31になる
      expect(actual[27], DateTime.parse("2022-05-31"));
    });
    test("estimatedEventCausingDateと複数の休薬期間がある場合", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      ...
      // estimatedEventCausingDateを2022-05-20に設定
      // 1回目の休薬は終了済み（2日間）、2回目は05-15から05-20まで（5日間）として計算される
      final actual = pillSheet.buildDates(
        estimatedEventCausingDate: DateTime.parse("2022-05-20"),
      );
      ...
      // 5日目は1回目の休薬期間（2日間）の影響で05-07になる
      expect(actual[4], DateTime.parse("2022-05-07"));
      // 12日目は2回目の休薬期間の影響で、さらに5日ずれる
      // 12日目: 本来05-12 + 1回目休薬2日 = 05-14、そこに2回目休薬開始後は05-20になる
      expect(actual[11], DateTime.parse("2022-05-14"));
      expect(actual[12], DateTime.parse("2022-05-20"));
    });
    test("estimatedEventCausingDateが休薬期間開始前の場合でも、終了済み休薬期間は計算に含まれる", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-06-01"));
      ...
      // estimatedEventCausingDateを2022-05-10に設定（休薬期間開始前）
      // ただし、終了済み休薬期間（endDateが設定されている）はestimatedEventCausingDateに関係なく影響する
      final actual = pillSheet.buildDates(
        estimatedEventCausingDate: DateTime.parse("2022-05-10"),
      );

      // 1日目〜14日目は通常通り
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[9], DateTime.parse("2022-05-10"));
      expect(actual[13], DateTime.parse("2022-05-14"));
      // 15日目は終了済み休薬期間（3日間）の影響で05-18になる
      expect(actual[14], DateTime.parse("2022-05-18"));
    });
    test("休薬期間の開始日と終了日が同じ日の場合（0日間の休薬）", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-30"));
      ...
      final pillSheet = PillSheet.v1(
        ...
        restDurations: [
          RestDuration(
            id: firestoreIDGenerator(),
            beginDate: DateTime.parse("2022-05-10"),
            endDate: DateTime.parse("2022-05-10"), // 同じ日
            createdDate: now(),
          ),
        ],
        typeInfo: PillSheetTypeInfo(
      ...
      // 開始日と終了日が同じなので、日付のシフトは発生しない
      expect(actual.length, 28);
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[9], DateTime.parse("2022-05-10"));
      expect(actual[27], DateTime.parse("2022-05-28"));
    });
    test("継続中の休薬期間がtodayで計算される確認", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-05-15"));
      ...
      // 1日目〜9日目は通常通り
      expect(actual[0], DateTime.parse("2022-05-01"));
      expect(actual[8], DateTime.parse("2022-05-09"));
      // 10日目から休薬期間の影響で、today(05-15)まで5日間ずれる
      expect(actual[9], DateTime.parse("2022-05-15"));
      expect(actual[10], DateTime.parse("2022-05-16"));
    });
  });
  ...
  group("#PillSheetV2", () {
    group("#lastCompletedTakenDate", () {
      test("未服用の場合はnullを返す", () {
        ...
        expect(pillSheet.lastCompletedTakenDate, null);
      });

      test("2日目を2回中1回だけ服用した場合、完了済みの1日目の服用日時を返す（lastTakenDateは2日目を返す）", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        expect(pillSheet.lastCompletedTakenDate, DateTime.parse("2022-05-01"));
        expect(pillSheet.lastTakenDate, DateTime.parse("2022-05-02"));
      });

      test("2日目まで完全服用した場合、2日目の服用日時を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        expect(pillSheet.lastCompletedTakenDate, DateTime.parse("2022-05-02"));
      });
    });
    ...
    group("#todayPillAllTaken", () {
      ...
      test("ピルシートの終了日を過ぎた場合でもRangeErrorが発生しない", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        // 21日型ピルシートで開始日が2022-05-01の場合、終了日は2022-05-21
        // 今日を2022-06-01に設定（ピルシート終了日を10日超過）
        when(
          mockTodayRepository.now(),
        ).thenReturn(DateTime.parse("2022-06-01"));
        ...
        // lastCompletedPillNumber = 21（最後の完了済みピル）
        // 32 != 21 なので false を返す
    ...
    group("#anyTodayPillsAreAlreadyTaken", () {
      ...
      test("ピルシートの終了日を過ぎた場合、todayPillIndexが範囲外になるためfalseを返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        // 21日型ピルシートで開始日が2022-05-01の場合、終了日は2022-05-21
        // 今日を2022-06-01に設定（ピルシート終了日を10日超過）
        ...
        // 境界チェックによりfalseを返す
        expect(
          pillSheet.todayPillIndex,
          greaterThanOrEqualTo(sheetType.totalCount),
        );
        expect(pillSheet.anyTodayPillsAreAlreadyTaken, false);
      });
    });
    ...
    group("#replacedPills", () {
      ...
      test("1番目のピルを更新した場合、1番目のみが置き換わる", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        final result = pillSheet.replacedPills(newPills: [updatedPill]);

        expect(result[0].pillTakens.length, 1);
        expect(result[1].pillTakens.length, 0);
        expect(result.length, pillSheet.pills.length);
      });

      test("複数のピルを連続して更新した場合、該当範囲のみ置き換わる", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        final result = pillSheet.replacedPills(newPills: updatedPills);

        expect(result[0].pillTakens.length, 2);
        expect(result[1].pillTakens.length, 2);
        expect(result[2].pillTakens.length, 0);
        expect(result.length, pillSheet.pills.length);
      });

      test("indexが範囲外のピルはassertエラーが発生する", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
        ...
        expect(
          () => pillSheet.replacedPills(newPills: [outOfRangePill]),
    ...
    group("#lastTakenDate", () {
      ...
      test("1錠だけ服用している場合（takenCount=2）は服用日時を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
      ...
      test("3日目まで服用している場合は3日目の服用日時を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
      ...
      test("途中のピルに服用記録がある場合は最後の記録日時を返す", () {
        final mockTodayRepository = MockTodayService();
        todayRepository = mockTodayRepository;
        when(
          mockTodayRepository.now(),
  ...
  group("#lastCompletedPillNumber", () {
    ...
    test("休薬期間がある場合でも正しいピル番号を返す", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-07-30"));
    ...
    test("途中のピルが未完了の場合、その前の完了済みピル番号を返す", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-07-27"));
    ...
    test("pillsの長さがtypeInfo.totalCountより少ない場合でもRangeErrorが発生しない", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-07-27"));
    ...
    test("pillsの長さがtypeInfo.totalCountより多い場合でもRangeErrorが発生しない", () {
      final mockTodayRepository = MockTodayService();
      todayRepository = mockTodayRepository;
      when(mockTodayRepository.now()).thenReturn(DateTime.parse("2022-08-05"));
