    ...
    group("has two pill sheets", () {
      test("it is plane pattern", () {
        ...
        final pillSheet1 = PillSheet(
          ...
          pills: Pill.generateAndFillTo(
              pillSheetType: sheetType, fromDate: DateTime.parse("2022-03-01"), lastTakenDate: DateTime.parse("2022-03-28"), pillTakenCount: 1),
        );
        final pillSheet2 = PillSheet(
          ...
          pills: Pill.generateAndFillTo(pillSheetType: sheetType, fromDate: DateTime.parse("2022-03-29"), lastTakenDate: null, pillTakenCount: 1),
        );
        // created at and id are anything value
        final pillSheetGroup = PillSheetGroup(
    ...
    group("has one pill sheet", () {
      test("it is not taken yet", () {
        ...
        final pillSheet = PillSheet(
          ...
          createdAt: now(),
          pills: Pill.generateAndFillTo(pillSheetType: sheetType, fromDate: DateTime.parse("2020-09-14"), lastTakenDate: null, pillTakenCount: 1),
        );
        // created at and id are anything value
        final pillSheetGroup = PillSheetGroup(
          pillSheetIDs: ["sheet_id"],
      ...
      group("pillsheet has rest durations", () {
        ...
        test("rest duration is ended and not yet taken pill", () {
          ...
          final pillSheet = PillSheet(
            ...
            pills: Pill.generateAndFillTo(pillSheetType: sheetType, fromDate: DateTime.parse("2020-09-01"), lastTakenDate: null, pillTakenCount: 1),
          );
          // created at and id are anything value
          final pillSheetGroup = PillSheetGroup(
            pillSheetIDs: ["sheet_id"],
      ...
      group("has two pill sheets", () {
        test("it is plane pattern", () {
          ...
          final pillSheet2 = PillSheet(
            ...
            pills: Pill.generateAndFillTo(
                pillSheetType: sheetType, fromDate: DateTime.parse("2022-03-29"), lastTakenDate: DateTime.parse("2022-03-29"), pillTakenCount: 1),
          );
          // created at and id are anything value
          final pillSheetGroup = PillSheetGroup(
            pillSheetIDs: ["sheet_id", "sheet_id2"],
